...
use App\Http\Model\Imports\SystemsImport;
use App\Http\Model\Exports\SystemsExport;
...
class SystemsController extends Controller
{
  ...
  public function __construct(Request $request)
 {
  ...
  public function data(Request $request){    
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = Systems::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(Systems::query(), $filter_conditions)->count();
        }else{
          $arr = Systems::get_raw_skip_page($skip,$perPage,$orderby,$asc);   
        }  
  ...
  public function save(Request $request){
    ...
    try{
     ...
     if($validator->passes()){
       $code_check = Systems::WhereCheck('code',$arr->code,'id',$arr->id)->first();
       if($code_check == null){
     if($permission['a'] == true && !$arr->id ){
       ...
       $data->value1 = $arr->value1;
       $data->value2 = $arr->value2;
       $data->value3 = $arr->value3;
       $data->value4 = $arr->value4;
       $data->value5 = $arr->value5;
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new SystemsExport($arr,$page), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
         'name' => "SystemsExportErmis", //no extention needed
