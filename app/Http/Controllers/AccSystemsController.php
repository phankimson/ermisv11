...
use App\Http\Model\Imports\AccSystemsImport;
  ...
  public function __construct(Request $request)
 {
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccSystems::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccSystems::query(), $filter_conditions)->count();
        }else{
  ...
  public function save(Request $request){
    ...
    try{
     ...
     if($validator->passes()){
      $code_check = AccSystems::WhereCheck('code',$arr->code,'id',$arr->id)->first();
      if($code_check == null){
