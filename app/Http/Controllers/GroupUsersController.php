...
class GroupUsersController extends Controller
{
  ...
  public function data(Request $request){    
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = GroupUsers::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(GroupUsers::query(), $filter_conditions)->count();
        }else{
          $arr = GroupUsers::get_raw_skip_page($skip,$perPage,$orderby,$asc);    
        }  
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new GroupUsersExport($arr,$page), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
