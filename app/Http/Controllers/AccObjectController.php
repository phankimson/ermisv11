  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccObject::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccObject::query(), $filter_conditions)->count();
        }else{
  ...
  public function save(Request $request){
    ...
    try{
     ...
     if($permission['a'] == true && !$arr->id ){
       ...
       // LÃƒâ€ Ã‚Â°u Object Filter Object type    
