...
class AccSuppliesGoodsTypeController extends Controller
{
  ...
  public function __construct(Request $request)
 {
  ...
  public function show(){
    ...
    return view('acc.supplies_goods_type',['paging' => $paging, 'key' => $this->key ]);
  }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccSuppliesGoodsType::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_sql);
 ...
 public function DownloadExcel(Request $request){
   return Storage::download('public/downloadFile/AccSuppliesGoodsType.xlsx');
 }
  ...
  $type = 5;
   ...
   if($permission['a'] && $request->hasFile('file')){
     ...
     $request->validate([
       ...
       // Lấy lại dữ liệu
       //$array = AccSuppliesGoodsType::get_raw();
