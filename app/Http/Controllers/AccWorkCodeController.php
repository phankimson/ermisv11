...
class AccWorkCodeController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = "AccWorkCode.xlsx"; // File download name
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccWorkCode::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccWorkCode::query(), $filter_conditions)->count();
        }else{
