...
class AccPrintTemplateController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = 'AccPrintTemplate.xlsx';
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccPrintTemplate::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccPrintTemplate::query(), $filter_conditions)->count();
        }else{
          $arr = AccPrintTemplate::get_raw_skip_page($skip,$perPage,$orderby,$asc); 
        }         
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new AccPrintTemplateExport($arr,$page), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
