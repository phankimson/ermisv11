...
class PosReturnController extends Controller
{
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            // Tao giao dich tra hang va cap nhat ton kho.
            $transaction = PosTransactionService::create('return', [
            ...
            return response()->json(['status' => true, 'message' => trans('pos.messages.saved_return'), 'data' => $transaction]);
        } catch (Throwable $e) {
