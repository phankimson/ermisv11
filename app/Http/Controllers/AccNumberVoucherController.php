...
class AccNumberVoucherController extends Controller
{
  ...
  public function __construct(Request $request)
  {
     ...
     $this->download = 'AccNumberVoucher.xlsx';
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccNumberVoucher::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccNumberVoucher::query(), $filter_conditions)->count();
        }else{
