...
class AccUnitController extends Controller
{
  ...
  public function __construct(Request $request)
 {
  ...
  public function data(Request $request){  
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccUnit::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccUnit::query(), $filter_conditions)->count();
        }else{
  ...
  public function save(Request $request){
    ...
    try{
     ...
     if($validator->passes()){
      $code_check = AccUnit::WhereCheck('code',$arr->code,'id',$arr->id)->first();
      if($code_check == null){
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new AccUnitExport($arr,$page), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
         'name' => "AccUnitExportErmis", //no extention needed
