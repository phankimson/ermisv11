...
use App\Http\Model\Imports\AccBankImport;
use App\Http\Model\Exports\AccBankExport;
...
class AccBankController extends Controller
{
  ...
  public function __construct(Request $request)
  {
     ...
     $this->download = "AccBank.xlsx";
 }

  public function show(){
    //$data = AccBank::get_raw();
    $count = AccBank::count();
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccBank::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccBank::query(), $filter_conditions)->count();
        }else{
 ...
 public function load(){
  ...
  public function save(Request $request){
    ...
    try{
     ...
     if($validator->passes()){
      $code_check = AccBank::WhereCheck('code',$arr->code,'id',$arr->id)->first();
      if($code_check == null){
