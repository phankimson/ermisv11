...
class AccBankController extends Controller
{
  ...
  public function show(){
    ...
    return view('acc.bank',['paging' => $paging, 'key' => $this->key ]);
  }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccBank::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_sql);
 ...
 public function DownloadExcel(){
   return Storage::download('public/downloadFile/AccBank.xlsx');
 }
