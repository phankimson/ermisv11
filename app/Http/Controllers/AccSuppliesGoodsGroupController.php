...
class AccSuppliesGoodsGroupController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = 'AccSuppliesGoodsGroup.xlsx';
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccSuppliesGoodsGroup::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccSuppliesGoodsGroup::query(), $filter_conditions)->count();
        }else{
