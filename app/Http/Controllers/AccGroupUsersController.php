  ...
  public function data(Request $request){  
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccGroupUsers::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions,$com->id);
          $total = Convert::applyFilterConditions(AccGroupUsers::query(), $filter_conditions)->where('company_id',$com->id)->count();
        }else{
