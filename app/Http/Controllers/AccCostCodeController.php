...
class AccCostCodeController extends Controller
{
  ...
  public function show(Request $request){    
    ...
    return view('acc.cost_code',['paging' => $paging, 'key' => $this->key ]);
  }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccCostCode::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_sql);
          $total = AccCostCode::whereRaw($filter_sql)->count();
        }else{
 ...
 public function DownloadExcel(){
   return Storage::download('public/downloadFile/AccCostCode.xlsx');
 }
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new AccCostCodeExport($arr), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
