...
use App\Http\Model\Imports\AccCostCodeImport;
use App\Http\Model\Exports\AccCostCodeExport;
...
class AccCostCodeController extends Controller
{
  ...
  public function __construct(Request $request)
  {
     ...
     $this->download = 'AccCostCode.xlsx';
 }

  public function show(Request $request){    
    //$data = AccCostCode::get_raw();
    $count = AccCostCode::count();
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccCostCode::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccCostCode::query(), $filter_conditions)->count();
        }else{
          $arr = AccCostCode::get_raw_skip_page($skip,$perPage,$orderby,$asc); 
        } 
  ...
  public function save(Request $request){
    ...
    try{
     ...
     if($validator->passes()){
      $code_check = AccCostCode::WhereCheck('code',$arr->code,'id',$arr->id)->first();
      if($code_check == null){
     if($permission['a'] == true && !$arr->id ){
       $type = 2;
       $data = new AccCostCode();
       $data->code = $arr->code;
       $data->name = $arr->name;
       ...
       // Lay ID de phan loai su kien update
       $arr->id = $data->id;
       $arr->t = $type;
 ...
 public function export(Request $request) {
   ...
   try{
    ...
    $page = $request->page;
       ...
       $myFile = Excel::raw(new AccCostCodeExport($arr,$page), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
         'name' => "AccCostCodeExportErmis", //no extention needed
