...
class AccStatisticalCodeController extends Controller
{
 ...
 {    
     ...
     $this->download = 'AccStatisticalCode.xlsx';
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccStatisticalCode::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccStatisticalCode::query(), $filter_conditions)->count();
        }else{
