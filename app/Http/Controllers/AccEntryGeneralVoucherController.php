...
class AccEntryGeneralVoucherController extends Controller
{
  use AccHistoryTraits,FileAttachTraits,NumberVoucherTraits,ReferenceTraits;
  protected $url;
  protected $key;
  protected $menu;
  protected $group;
  ...
  public function __construct(Request $request)
 {
     ...
     $this->print = 'TH%';
     $this->path = 'PATH_UPLOAD_ENTRY_GENERAL';
     $this->document = 'DOCUMENT_TAX';
     $this->download = 'AccEntryGeneralVoucher.xlsx';
 }
   ...
   $type = 5;
    ...
    if($permission['a'] && $request->hasFile('file')){
      ...
      $request->validate([
        ...
        $detail = new AccEntryGeneralVoucherImport($this->menu);
