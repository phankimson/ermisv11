...
use App\Http\Model\Imports\AccStockImport;
use App\Http\Model\Exports\AccStockExport;
...
class AccStockController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = 'AccStock.xlsx';
 }

  public function show(){
    //$data = AccStock::get_raw();  
    $count = AccStock::count();
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccStock::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccStock::query(), $filter_conditions)->count();
        }else{
          $arr = AccStock::get_raw_skip_page($skip,$perPage,$orderby,$asc); 
        }   
  ...
  public function save(Request $request){  
    ...
    try{
     ...
     if($validator->passes()){
      $code_check = AccStock::WhereCheck('code',$arr->code,'id',$arr->id)->first();
      if($code_check == null){
