...
class LicenseController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = "License.xlsx"; // File download name
 }
  ...
  public function data(Request $request){    
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = License::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(License::query(), $filter_conditions)->count();
        }else{
  ...
  public function load(){
    ...
    try{
      ...
      //dump($sys);
      $random = Str::random($sys->value);
      return response()->json(['status'=>true,'data'=> $random ]);
    }catch(Exception $e){
  ...
  public function save(Request $request){
    ...
    try{
     ...
     if($validator->passes()){
       $code_check = License::WhereCheck('keygen',$arr->keygen,'id',$arr->id)->first();
       if($code_check == null){
     if($permission['a'] == true && !$arr->id ){
       ...
       $data->keygen = $arr->keygen == '' ? Str::random($sys->value) : $arr->keygen;
       $data->company_use = $arr->company_use;
