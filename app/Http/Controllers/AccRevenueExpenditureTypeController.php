...
class AccRevenueExpenditureTypeController extends Controller
{
  public function __construct(Request $request)
 {
  ...
  public function show(Request $request){
    ...
    return view('acc.revenue_expenditure_type',['data' => $data, 'key' => $this->key ]);
  }
  ...
  $type = 5;
   ...
   if($permission['a'] && $request->hasFile('file')){
     ...
     $request->validate([
       ...
       $file = $request->file;
       // Import dữ liệu
       Excel::import(new AccRevenueExpenditureTypeImport, $file);
       // Lấy lại dữ liệu
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new AccRevenueExpenditureTypeExport($arr), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
