...
class AccWarrantyPeriodController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = "AccWarrantyPeriod.xlsx"; 
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccWarrantyPeriod::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccWarrantyPeriod::query(), $filter_conditions)->count();
        }else{
