...
class AccNumberCodeController extends Controller
{
  ...
  public function __construct(Request $request)
  {
     ...
     $this->download = 'AccNumberCode.xlsx';
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccNumberCode::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccNumberCode::query(), $filter_conditions)->count();
        }else{
