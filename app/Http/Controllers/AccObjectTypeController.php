...
class AccObjectTypeController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = 'AccObjectType.xlsx';
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccObjectType::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccObjectType::query(), $filter_conditions)->count();
        }else{
