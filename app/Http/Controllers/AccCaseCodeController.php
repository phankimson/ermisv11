...
class AccCaseCodeController extends Controller
{
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccCaseCode::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_sql);
          $total = AccCaseCode::whereRaw($filter_sql)->count();
        }else{
 ...
 public function DownloadExcel(){
   return Storage::download('public/downloadFile/AccCaseCode.xlsx');
 }
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new AccCaseCodeExport($arr), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
