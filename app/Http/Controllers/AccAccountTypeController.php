...
class AccAccountTypeController extends Controller
{
  ...
  public function __construct(Request $request)
  {
     ...
     $this->download = "AccAccountType.xlsx";
 }
  ...
  public function data(Request $request){   
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = AccAccountType::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(AccAccountType::query(), $filter_conditions)->count();
        }else{
