...
class AreaController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = "Area.xlsx"; // File download name
 }
  ...
  public function data(Request $request){    
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = Area::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(Area::query(), $filter_conditions)->count();
        }else{
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new AreaExport($arr,$page), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
