...
class DocumentController extends Controller
{
  ...
  public function data(Request $request){    
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = Document::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_sql);
          $total = Document::whereRaw($filter_sql)->count();
        }else{
 ...
 public function DownloadExcel(Request $request){
   return Storage::download('public/downloadFile/Document.xlsx');
 }
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new DocumentExport($arr), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
