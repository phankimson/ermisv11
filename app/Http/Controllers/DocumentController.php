...
class DocumentController extends Controller
{
  ...
  public function __construct(Request $request)
 {
     ...
     $this->download = "Document.xlsx"; // File download name
 }
  ...
  public function data(Request $request){    
    ...
    $asc  = 'desc';
        ...
        if($filter){
          ...
          $arr = Document::get_raw_skip_filter_page($skip,$perPage,$orderby,$asc,$filter_conditions);
          $total = Convert::applyFilterConditions(Document::query(), $filter_conditions)->count();
        }else{
          $arr = Document::get_raw_skip_page($skip,$perPage,$orderby,$asc);    
        } 
  ...
  public function save(Request $request){
    ...
    try{
     ...
     if($validator->passes()){
      $code_check = Document::WhereCheck('code',$arr->code,'id',$arr->id)->first();
      if($code_check == null){
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new DocumentExport($arr,$page), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
         'name' => "DocumentExportErmis", //no extention needed
