...
class AccObjectGroupController extends Controller
{
 ...
 public function DownloadExcel(Request $request){
   return Storage::download('public/downloadFile/AccObjectGroup.xlsx');
 }
  ...
  $type = 5;
   ...
   if($permission['a'] && $request->hasFile('file')){
     ...
     $request->validate([
       ...
       $file = $request->file;
       // Import dữ liệu
       Excel::import(new AccObjectGroupImport, $file);
       // Lấy lại dữ liệu
       $array = AccObjectGroup::get_raw();
 ...
 public function export(Request $request) {
   ...
   try{
       ...
       $myFile = Excel::raw(new AccObjectGroupExport($arr), \Maatwebsite\Excel\Excel::XLSX);
       $response =  array(
         'status' =>true,
