...
class AccBankPaymentVoucherController extends Controller
{
  ...
  public function __construct(Request $request)
 {
  ...
  public function show(){
    ...
    return view('acc.payment_bank_voucher',[ 'key' => $this->key , 'voucher' => $voucher, 'menu'=>$this->menu->id, 'menu_tab' => $menu_tab,                                    
  ...
  public function DownloadExcel(){
    return Storage::download('public/downloadFile/AccBankPaymentVoucher.xlsx');
  }
