...
class CashReceiptDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'debit' => LangDropDownListResource::make($this->debit()->first()),
            'credit' => LangDropDownListResource::make($this->credit()->first()),
            'amount' => $this->amount,
            'rate' => $this->rate,
            ...
            'work_code' =>  LangDropDownListResource::make($this->work_code()->first()),
            'accounted_fast' => LangDropDownListResource::make($this->accounted_fast()->first()),
