...
class CashPaymentDetailReadResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'bank_account' =>  !$this->bank_account_debit ? DefaultDropDownResource::make("") : BankDropDownResource::make($this->bank_account_debit()->first()),
            'status' =>  $this->status,
            'active' =>  $this->active,
        ];
    }
