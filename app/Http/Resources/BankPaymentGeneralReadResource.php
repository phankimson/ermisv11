...
use App\Http\Resources\BankPaymentDetailReadResource;
use App\Http\Resources\ObjectDropDownListResource;
use App\Http\Resources\TaxReadResource;

class BankPaymentGeneralReadResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'status' =>  $this->status,
            'detail' => BankPaymentDetailReadResource::collection($this->whenLoaded('detail')),
