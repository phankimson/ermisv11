    ...
    public function toArray($request)
    {
        if($this->inventory){
            return [
                ...
                'stock_issue' => $this->inventory->stock_issue ? optional($this->inventory->stock_issue_item)->code : null,
                'stock_receipt' => $this->inventory->stock_receipt ? optional($this->inventory->stock_receipt_item)->code : null,
