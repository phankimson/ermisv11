...
class CashReceiptDetailPaymentReadResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'bank_account' =>  !$this->bank_account ? DefaultDropDownResource::make($this->bank_account) : BankDropDownResource::make($this->bank_account()->first()),
            'status' =>  $this->status,
            'active' =>  $this->active,
        ];
    }
