...
class AccDetail extends Model
{
  use ScopesTraits,BootedTraits;
      ...
      protected $with = ['accounted_fast','debit','credit','case_code','statistical_code','cost_code','work_code','department','bank_account_debit','bank_account_credit','subject_credit','subject_debit','inventory'];
      ...
      public function subject_debit() {
        return $this->belongsTo(AccObject::class,'subject_id_debit','id');
      }
      public function inventory() {
        return $this->hasOne(AccInventory::class,'detail_id','id');
      }
}
