...
class AccUnit extends Model
{
      ...
      static public function get_raw() {
        $result = AccUnit::WithRowNumberDb('mysql2')->orderBy('row_number','desc')->get();       
        return $result;
      }
      ...
      static public function get_raw_export($select,$skip,$limit) {
        $result =  AccUnit::WithRowNumberDb('mysql2')->orderBy('row_number','asc')->skip($skip)->take($limit)->get(['row_number',DB::raw($select)]);        
        return $result;
      } 
