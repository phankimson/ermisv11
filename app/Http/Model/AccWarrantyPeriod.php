...
class AccWarrantyPeriod extends Model
{
      ...
      static public function get_raw_skip_page($skip,$limit,$orderBy,$asc) {
        $result = AccWarrantyPeriod::WithRowNumberDb('mysql2',$orderBy,$asc)->skip($skip)->take($limit)->get();  
        return $result;
      }

      static public function get_raw_skip_filter_page($skip,$limit,$orderBy,$asc,$filter) {
        $result = AccWarrantyPeriod::WithRowNumberWhereRawColumnDb('mysql2',$filter,$orderBy,$asc)->skip($skip)->take($limit)->get();  
        return $result;
      }
