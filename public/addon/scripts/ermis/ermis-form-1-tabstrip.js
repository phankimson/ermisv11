...
var Ermis = function () {
    ...
    var initStatus = function (flag) {
        ...
        var tabstrip = ts.data("kendoTabStrip");
        //get the items
    ...
    var initSave = function (e) {
      ...
      arr.key = Ermis.link;
      arr.ts = tss;
      ErmisTemplateAjaxPostAdd4(e, tss, data, Ermis.link+'-save', arr ,dataId,
        function(result){
   ...
   // ---------------
    ...
    var initTooltipMaxLenght = function(){
      ErmisTooltipMaxlenght('[data-maxlength]');
    };
