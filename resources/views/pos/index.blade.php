...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('addon/css/style_pos.css')}}">
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
  <script src="https://unpkg.com/idb/build/iife/index-min.js"></script>
  <script src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.8.2/dist/alpine.min.js"></script>
  <script src="{{ asset('addon/scripts/pos/script.js') }}"></script>
</head>
      ...
      <div class="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-cyan-500 rounded-3xl">
        <a href="{{url($lang.'/pos')}}"
           class="flex items-center justify-center h-12 w-12 bg-cyan-50 text-cyan-700 rounded-full">
            <img src="{{ asset('addon/img/icon.png') }}" alt="Logo" class="h-6 w-6">
        </a>
