       ...
       <li>
           <table>
               <tr>
                   ...
                   <td>
                       <select class="droplist read large" data-position="3" data-title="@lang('company.country')" data-template="#= FormatDropListRead(country,'country') #" data-hidden="true" data-type="number" data-width="200px" data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.manage.'.env('URL_DROPDOWN').'.country')}}"  name="country">
                       </select>
                   </td>
               </tr>
               <tr>
                   ...
                   <td>
                       <select class="droplist read large" data-position="3" data-title="@lang('company.regions')" data-template="#= FormatDropListRead(regions,'regions') #" data-hidden="true" data-type="number" data-width="200px"  data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.manage.'.env('URL_DROPDOWN').'.regions')}}"  name="regions">
                       </select>
                   </td>
               </tr>
               <tr>
                   ...
                   <td>
                       <select class="droplist read large" data-position="3" data-title="@langt('company.area')" data-template="#= FormatDropListRead(area,'area') #" data-hidden="true" data-type="number" data-width="200px" data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.manage.'.env('URL_DROPDOWN').'.area')}}"  name="area">
                       </select>
                   </td>
               </tr>
               <tr>
                   ...
                   <td>
                       <select class="droplist read large" data-position="3" data-title="@lang('company.distric')" data-template="#= FormatDropListRead(distric,'distric') #" data-hidden="true" data-type="number" data-width="200px"  data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.manage.'.env('URL_DROPDOWN').'.distric')}}" name="distric">
                       </select>
                   </td>
               </tr>
               <tr>
