...
@section('content_add')
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text" class="k-textbox large" data-position="3" data-title="@lang('software.image')" data-template="#= FormatImageTooltip(image) #" data-width="90px" data-type="string" name="image" /></td>
        </tr>
        <tr>
