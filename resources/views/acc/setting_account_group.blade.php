...
@section('content_add')
    ...
    <table>
      ...
      <tr>
          ...
          <td>
           <select class="multiselect read large" data-position="7" data-hidden="true" name="account_filter" data-type="arr" multiple="multiple" data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.account').'?multiple=true'}}"  data-placeholder="Select">
           </select>     
          </td>
      </tr>
      <tr>
