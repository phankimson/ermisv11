       ...
       <li>
           <table>
               <tr>
                   ...
                   <td>
                     <span class="input-group-addon"><span id="prefix_username">{{$prefix_username}}_</span></span>
                     <input type="text" class="k-textbox medium prefix" data-position="2" data-title="@lang('login.username')" data-width="200px" data-type="string" name="username"  />
                   </td>
               </tr>
               <tr>
