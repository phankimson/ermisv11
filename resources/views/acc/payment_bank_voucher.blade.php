...
<div class="uk-width-medium-4-4 search-table-outter">
    @include('action.content_3',['voucher'=>$voucher])
</div>
@endsection
...
<script>
    jQuery(document).ready(function () {
        ...
        Ermis.columns    = [{"field" :"id", hidden : true},
                            ...
                            { "field" : "bank_account", hidden : true,"url" : "{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.bank-account')}}" , editor: ItemsReadDropDownEditor , "select" : "OnchangeItem" ,template : "#=getUrlAjaxItemName(bank_account,'bank_account')#"  ,"width" : "150px" ,"set" : "2" },
