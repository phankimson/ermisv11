...
@section('content_add')
    ...
    <table>
      ...
      <td>
      <select class="droplist read large" data-position="1" data-title="@lang('acc_number_voucher.menu')" data-template="#= FormatDropListRead(menu_id,'menu_id') #" data-type="number" data-width="200px"  data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.menu')}}" name="menu_id">
      ...
      <td>
      <select class="droplist read large" data-position="1" data-title="@lang('acc_number_voucher.menu_general')" data-template="#= FormatDropListRead(menu_general_id,'menu_general_id') #" data-type="number" data-width="200px"  data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.menu')}}" name="menu_general_id">
