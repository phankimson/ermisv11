...
@section('content_add')
    ...
    <table>
      <tr>
          <td class="row-label"><label>@lang('acc_object_group.code') *</label></td>
          <td>
            <span class="k-textbox k-space-right medium">
                  <input type="text" data-position="1" data-title="@lang('acc_object_group.code')" data-width="200px" maxlength="50" data-type="string" name="code" id="icon-right">
                  <a href="javascript:;" class="k-icon k-i-rotate load">&nbsp;</a>
            </span>
          </td>
      </tr>
      <tr>
          <td class="row-label"><label>@lang('acc_object_group.name') </label></td>
          <td><input type="text" class="k-textbox xxlarge" data-position="3" data-title="@lang('acc_object_group.name')" data-width="200px" maxlength="100" data-type="string" name="name" /></td>
      </tr>
      <tr>
          <td class="row-label"><label>@lang('acc_object_group.name_en') </label></td>
          <td><input type="text" class="k-textbox xxlarge" data-position="3" data-title="@lang('acc_object_group.name_en')" data-width="200px" maxlength="100" data-type="string" name="name_en" /></td>
      </tr>
        <tr>
...
<script>
  jQuery(document).ready(function () {
      ...
      Ermis.data_expend = [{field : "code", column:  "@lang('acc_object_group.code')" },
                           {field : "name", column:  "@lang('acc_object_group.name')" },
                           {field : "name_en", column:  "@lang('acc_object_group.name_en')" },
