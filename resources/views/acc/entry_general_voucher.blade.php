...
<script>
    jQuery(document).ready(function () {
        ...
        Ermis.columns    = [{"field" :"id", hidden : true},
                            ...
                            { "field" : "debit","title" :"@lang('acc_voucher.debt_account')" ,"url" : "{!!route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.account-voucher-filter').'?menu='.$menu.'&type=1&option=true'!!}",editor: ItemsReadDropDownEditor , "select" : "OnchangeItem" ,template : "#=getUrlAjaxItemName(debit,'debit')#" ,"width" : "150px" ,"set" : "2" , "key" :true , "field_check" : "subject_code_debit" },
                            { "field" : "credit","title" :"@lang('acc_voucher.credit_account')" ,"url" : "{!!route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.account-voucher-filter').'?menu='.$menu.'&type=2&option=true'!!}",editor: ItemsReadDropDownEditor , "select" : "OnchangeItem" ,template : "#=getUrlAjaxItemName(credit,'credit')#" ,"width" : "150px","set" : "2" , "key" :true , "field_check" : "subject_code_credit" },
                            ...
                            { "field" : "subject_code_debit","title" : "@lang('acc_voucher.subject_code_debit')"  ,"url" : "{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.object')}}" ,width : '150px',editor: ItemsReadDropDownEditor ,template : "#=getUrlAjaxItemName(subject_code_debit,'subject_code','subject_code')#" ,"set" : "2" },                           
                            { "field" : "subject_code_credit","title" : "@lang('acc_voucher.subject_code_credit')"  ,"url" : "{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.object')}}" ,width : '150px',editor: ItemsReadDropDownEditor ,template : "#=getUrlAjaxItemName(subject_code_credit,'subject_code','subject_code')#" ,"set" : "2"},                            
        ...
        Ermis.field = {
            ...
            subject_code_debit: { field : "subject_code_debit", defaultValue: DefaultReadValueField() },
            subject_code_credit: { field : "subject_code_credit", defaultValue: DefaultReadValueField() },
