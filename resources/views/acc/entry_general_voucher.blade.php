...
<script>
    jQuery(document).ready(function () {
        ...
        Ermis.column_grid = [{ "field" : "id",hidden: true },
                            ...
                            { "field" : "vat_account","title" : "@lang('acc_voucher.vat_account')",width : '200px',"url" : "{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.setting-account-group').'?code=VAT'}}",editor: ItemsReadDropDownEditor , "select" : "OnchangeGroup" ,template : "#=getUrlAjaxItemName(vat_account,'vat_account')#", "group" : "1" },
