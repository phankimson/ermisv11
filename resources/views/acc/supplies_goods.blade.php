   ...
   <section id="tabs_content" style="width : 100%" class="uk-switcher-hot uk-margin">
       <div class="uk-tab-content">
           ...
           <tr>
                 ...
                 <td>
                 <select class="droplist read large" data-position="4" data-title="@lang('acc_supplies_goods.unit')" data-template="#= FormatDropListRead(unit_id,'unit_id') #" data-type="number" data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.unit')}}" data-width="200px" name="unit_id">
                 ...
                 <td>
                 <select class="droplist read large" data-position="4" data-title="@lang('acc_supplies_goods.group')" data-template="#= FormatDropListRead(group,'group') #" data-type="number" data-width="200px" data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.supplies-goods-group')}}" name="group">
                 ...
                 <td>
                 <select class="droplist read large" data-position="4" data-title="@lang('acc_supplies_goods.warranty_period')" data-template="#= FormatDropListRead(warranty_period,'warranty_period') #" data-type="number" data-width="200px"  data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.warranty-period')}}"  name="warranty_period">
                 ...
                 <td>
                 <select class="droplist read large" data-position="4" data-title="@lang('acc_supplies_goods.stock_default')" data-template="#= FormatDropListRead(stock_default,'stock_default') #" data-type="number" data-width="200px" data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.stock')}}"  name="stock_default">
       ...
       <div class="uk-tab-content">
         <table>
               ...
               <td>
               <select class="droplist read large" data-position="4" data-title="@lang('acc_supplies_goods.stock_account')" data-template="#= FormatDropListRead(stock_account,'stock_account') #" data-type="number"  data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.setting-account-group').'?code=KH'}}" data-width="200px" name="stock_account">
               ...
               <td>
               <select class="droplist read large" data-position="4" data-title="@lang('acc_supplies_goods.revenue_account')" data-template="#= FormatDropListRead(revenue_account,'revenue_account') #" data-type="number" data-width="200px"  data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.setting-account-group').'?code=DT'}}"  name="revenue_account">
               ...
               <td>
               <select class="droplist read large" data-position="4" data-title="@lang('acc_supplies_goods.cost_account')" data-template="#= FormatDropListRead(cost_account,'cost_account') #" data-type="number" data-width="200px" data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.setting-account-group').'?code=CP'}}" name="cost_account">
               ...
               <td>
               <select class="droplist read large" data-position="4" data-title="@lang('acc_supplies_goods.vat_tax')" data-template="#= FormatDropListRead(excise_tax,'excise_tax') #" data-type="number" data-width="200px" data-value-field="value" data-text-field="text" data-read-url="{{route(env('URL_API').'.acc.'.env('URL_DROPDOWN').'.excise-tax')}}"  name="excise_tax">
