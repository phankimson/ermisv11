  ...
  jQuery(document).ready(function () {
      ...
      Ermis.column_grid = [{ "field" : "id",hidden: true },
            ...
            Ermis.columns    =   [{ "field" : "id",hidden: true },
                                ...
                                { "field" : "stock_receipt","title" : "@lang('acc_voucher.stock_receipt') " ,"width" : "100px" },
                                ...
                                { "field" : "price","title" : "@lang('acc_supplies_goods.price_purchase') " ,"width" : "150px" ,template: '#= FormatNumberDecimal(price,{{$decimal}}) #',"set" : "3"},
