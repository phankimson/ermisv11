...
<script>
    jQuery(document).ready(function () {
        ...
        Ermis.columns    = [{"field" :"id", hidden : true},
                            { "field" : "accounted_fast","title" :"@lang('acc_voucher.accounted_fast')","url" : "{{env('URL_DROPDOWN').'/accounted-fast'}}" ,editor: ItemsReadDropDownEditor , "select" : "OnchangeCancel" ,template : "#=getUrlAjaxItemName(accounted_fast,'accounted_fast','{{env('URL_DROPDOWN').'/accounted-fast'}}')#","width" : "150px" ,"set" : "5" },
                            ...
                            { "field" : "debit","title" :"@lang('acc_voucher.debt_account')" ,"url" : "{!!env('URL_DROPDOWN').'/account-voucher-filter?'.'menu='.$menu.'&type=1'!!}",editor: ItemsReadDropDownEditor , "select" : "OnchangeItem" ,template : "#=getUrlAjaxItemName(debit,'debit','{!!env('URL_DROPDOWN').'/account-voucher-filter?'.'menu='.$menu.'&type=1'!!}')#" ,"width" : "150px" ,"set" : "2" , "key" :true },
                            { "field" : "credit","title" :"@lang('acc_voucher.credit_account')" ,"url" : "{!!env('URL_DROPDOWN').'/account-voucher-filter?'.'menu='.$menu.'&type=2'!!}",editor: ItemsReadDropDownEditor , "select" : "OnchangeItem" ,template : "#=getUrlAjaxItemName(credit,'credit','{!!env('URL_DROPDOWN').'/account-voucher-filter?'.'menu='.$menu.'&type=2'!!}')#" ,"width" : "150px","set" : "2" , "key" :true},
                            ...
                            { "field" : "work_code","title" :"@lang('acc_voucher.work_code')","url" : "{{env('URL_DROPDOWN').'/work-code'}}",editor: ItemsReadDropDownEditor , "select" : "OnchangeItem" ,template : "#=getUrlAjaxItemName(work_code,'work_code','{{env('URL_DROPDOWN').'/work-code'}}')#" ,"width" : "150px"  ,"set" : "2"},
