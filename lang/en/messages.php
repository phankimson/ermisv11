...
return [
  ...
  "update_fail" => "Updated fail ! Please try again",
  "update_error" => "Updated error ! Please try again",
  "delete_success" => "Deleted Successful !",
  "delete_fail" => "Deleted fail ! Please try again",
  "delete_error" => "Deleted error !",
  "print_fail" => "Printed fail ! Please try again",
  "check_success" => "Checked Successful !",
  "check_fail" => "Checked fail ! Please try again",
  "check_error" => "Checked error",
  "uncheck_success" => "UnChecked Successful !",
  "uncheck_fail" => "UnChecked fail ! Please try again",
  "uncheck_error" => "UnChecked error",
  "recored_success" => "Recorded Successful !",
  "recored_fail" => "Recorded fail ! Please try again",
  "recored_error" => "Recorded error",
  "unrecored_success" => "Unrecorded Successful !",
  "unrecored_fail" => "Unrecorded fail ! Please try again",
  "unrecored_error" => "Unrecorded error",
  "connect_success" => "Connected Successful !",
  "connect_fail" => "Connected Fail !",
  "change_password_success" => "Changed password Successful ! Please login again .",
  "password_not_correct" => "Password old is not correct !",
  "change_password_fail" => "Changed password Failed ! Please try again .",
  ...
  "stock_transfer_is_duplicated"=>"Stock transfer is duplicated !",
  "stock_issue_or_stock_receive_is_empty"=>"Stock issue or stock receive is empty !",
